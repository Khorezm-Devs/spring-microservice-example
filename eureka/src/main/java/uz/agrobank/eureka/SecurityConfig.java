...
//    @Autowired
//    public void configureGlobal(AuthenticationManagerBuilder authservice) throws Exception {
//        authservice
//	.inMemoryAuthentication()
//		.passwordEncoder(NoOpPasswordEncoder.getInstance())
//		.withUser("mpOwner").password("mp19181975Secret").roles("SYSTEM");
//       // authservice.inMemoryAuthentication().withUser("mpOwner").password("mp19181975Secret").roles("SYSTEM");
//    }
//
//    @Override
...
//        @Autowired
//        public void configureGlobal(AuthenticationManagerBuilder authservice) throws Exception {
//            authservice.inMemoryAuthentication();
//        }
//
//        @Override
//        protected void configure(HttpSecurity http) throws Exception {
